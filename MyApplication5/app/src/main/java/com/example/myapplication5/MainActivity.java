...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String mPassword = "18990142";
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990142 赖志龙"};
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(com.example.myapplication5.MainActivity.this, mView);
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) {
            ...
            if (rb_password.isChecked()) {
                Intent intent = new Intent(this, com.example.myapplication5.LoginForgetActivity.class);
            ...
            if (rb_password.isChecked()) {
                Intent intent = new Intent(this, com.example.myapplication5.SQLiteWriteActivity.class);
                startActivityForResult(intent, mRequestCode);
            }
        }
    }

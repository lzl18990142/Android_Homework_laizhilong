...
import com.example.a20201120.adapter.CartAdapter;
...
public class ShoppingCartProActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    private Runnable mPopupMenu = new Runnable() {
        ...
        public void run() {
            ...
            // 构建购物车商品列表的适配器对象
            CartAdapter adapter = new CartAdapter(com.example.a20201120.ShoppingCartProActivity.this, mCartArray);
            // 给lv_cart设置商品列表适配器
            lv_cart.setAdapter(adapter);
            // 重新设置lv_cart的点击监听器
            lv_cart.setOnItemClickListener(com.example.a20201120.ShoppingCartProActivity.this);
            // 重新设置lv_cart的长按监听器
            lv_cart.setOnItemLongClickListener(com.example.a20201120.ShoppingCartProActivity.this);
        }
    };

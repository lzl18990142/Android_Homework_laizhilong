...
import com.example.a20201120.adapter.GoodsAdapter;
import com.example.a20201120.adapter.GoodsAdapter.addCartListener;
import com.example.a20201120.bean.CartInfo;
import com.example.a20201120.bean.GoodsInfo;
import com.example.a20201120.database.CartDBHelper;
import com.example.a20201120.database.GoodsDBHelper;
import com.example.a20201120.util.DateUtil;
import com.example.a20201120.util.FileUtil;
import com.example.a20201120.util.SharedUtil;
...
public class ShoppingChannelActivity extends AppCompatActivity implements View.OnClickListener, addCartListener{
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.iv_cart) { // 点击了购物车图标
            // 跳转到购物车页面
            Intent intent = new Intent(this, com.example.a20201120.ShoppingCartProActivity.class);
    ...
    private void downloadGoods() {
        ...
        mFirst = SharedUtil.getIntance(this).readShared("first", "true");
        // 获取当前App的私有存储路径
        String path = com.example.a20201120.MainApplication.getInstance().getExternalFilesDir(
        ...
        if (mFirst.equals("true")) { // 如果是首次打开
            ...
            for (int i = 0; i < goodsList.size(); i++) {
                ...
                com.example.a20201120.MainApplication.getInstance().mIconMap.put(rowid, thumb);
            ...
            for (int i = 0; i < goodsArray.size(); i++) {
                ...
                // 把该位图对象保存到应用实例的全局变量中
                com.example.a20201120.MainApplication.getInstance().mIconMap.put(info.rowid, thumb);
            }
        }
        // 把是否首次打开写入共享参数
        SharedUtil.getIntance(this).writeShared("first", "false");

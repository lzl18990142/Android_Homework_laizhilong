...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_shopping_channel) { // 点击了“商场”按钮
            // 跳转到手机商场页面
            Intent intent = new Intent(this, com.example.a20201120.MainActivity.class);
    ...
    private void showCart() {
        ...
        for (int i = 0; i < mCartArray.size(); i++) {
            ...
            iv_thumb.setImageBitmap(com.example.a20201120.MainApplication.getInstance().mIconMap.get(info.goods_id));

package com.example.a20201120.util;
...
import com.example.a20201120.R;
import com.example.a20201120.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.cellphonemall_04,
            R.drawable.cellphonemall_02, R.drawable.cellphonemall_03, R.drawable.cellphonemall_04};
